...
parser = argparse.ArgumentParser(description="Run Process Autopilot training with specified dataset and state abstraction.")
parser.add_argument('--dataset', type=str, required=True, help="Dataset name (e.g., 'bpi2017')")
