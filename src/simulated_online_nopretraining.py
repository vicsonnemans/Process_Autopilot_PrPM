...
print(f"=====Online learning for {dataset} ====")
...
filename = f"{dataset}_{state_abstraction}_{benchmark}_online_nopretraining_{k}.pkl"
training_filename = os.path.join(results_dir, filename)
